...
// validate Friend in joining reason
const validateReasonForJoining = (input) => {
  if (formData.value.reason && formData.value.reason.toLowerCase().includes('friend') ){
    if (input) errors.value.reason = "Great to have friend."
  }else{
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              @input="() => validateReasonForJoining(true)"
            ></textarea>
